...
#7
HV1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV1 <- do.call(cbind, HV1)

#8
Barren1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren1 <- do.call(cbind, Barren1)

write.csv(GDP1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP1.csv")
write.csv(RHU1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU1.csv")
write.csv(PRE1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE1.csv")
write.csv(PRS1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS1.csv")
write.csv(SSD1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD1.csv")
write.csv(HV1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV1.csv")
write.csv(Barren1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren1.csv")
write.csv(MammalRichness1,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness1.csv")
