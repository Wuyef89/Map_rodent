...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test3.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk3.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution3.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image3.RData")
...
#5
DNT3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT3 <- do.call(rbind, DNT3)

#6
EVP3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP3 <- do.call(rbind, EVP3)

#7
TEM3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM3 <- do.call(rbind, TEM3)
...
write.csv(MammalRichness3,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness3.csv")
write.csv(GST3,"BRT/OUTPUT/PLAGUE/VAR/GST3.csv")
write.csv(SSD3,"BRT/OUTPUT/PLAGUE/VAR/SSD3.csv")
write.csv(GDP3,"BRT/OUTPUT/PLAGUE/VAR/GDP3.csv")
write.csv(DNT3,"BRT/OUTPUT/PLAGUE/VAR/DNT3.csv")
write.csv(EVP3,"BRT/OUTPUT/PLAGUE/VAR/EVP3.csv")
write.csv(TEM3,"BRT/OUTPUT/PLAGUE/VAR/TEM3.csv")
write.csv(PRE3,"BRT/OUTPUT/PLAGUE/VAR/PRE3.csv")
write.csv(RHU3,"BRT/OUTPUT/PLAGUE/VAR/RHU3.csv")
write.csv(Elevation3,"BRT/OUTPUT/PLAGUE/VAR/Elevation3.csv")
write.csv(PRS3,"BRT/OUTPUT/PLAGUE/VAR/PRS3.csv")
