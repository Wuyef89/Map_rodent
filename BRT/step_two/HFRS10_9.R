...
write.csv(test_table, "BRT/OUTPUT/HFRS/TEST/test9.csv")
...
writeRaster(HFRS.risk, 
            filename = "BRT/OUTPUT/HFRS/TIF/HFRS_risk9.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/HFRS/CONTRIBUTION/contribution9.csv")
save.image("BRT/OUTPUT/HFRS/IMAGE/image9.RData")
...
write.csv(GDP9,"BRT/OUTPUT/HFRS/VAR/GDP9.csv")
write.csv(Elevation9,"BRT/OUTPUT/HFRS/VAR/Elevation9.csv")
write.csv(Barren9,"BRT/OUTPUT/HFRS/VAR/Barren9.csv")
write.csv(PRS9,"BRT/OUTPUT/HFRS/VAR/PRS9.csv")
write.csv(MammalRichness9,"BRT/OUTPUT/HFRS/VAR/MammalRichness9.csv")
write.csv(SSD9,"BRT/OUTPUT/HFRS/VAR/SSD9.csv")
write.csv(PRE9,"BRT/OUTPUT/HFRS/VAR/PRE9.csv")
write.csv(WIN9,"BRT/OUTPUT/HFRS/VAR/WIN9.csv")
write.csv(RHU9,"BRT/OUTPUT/HFRS/VAR/RHU9.csv")
write.csv(GST9,"BRT/OUTPUT/HFRS/VAR/GST9.csv")
