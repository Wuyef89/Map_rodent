...
write.csv(test_table,"BRT/OUTPUT/TYPHUS/TEST/test10.csv")
...
writeRaster(typhus.risk, 
            filename = "BRT/OUTPUT/TYPHUS/TIF/typhus_risk10.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/TYPHUS/CONTRIBUTION/contribution10.csv")
save.image("BRT/OUTPUT/TYPHUS/IMAGE/image10.RData")
...
Elevation10 <- do.call(cbind, Elevation10)
...
MammalRichness10 <- do.call(cbind, MammalRichness10)

#4
SSD10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"SSD"), model = i)
})
SSD10 <- do.call(cbind, SSD10)

#5
PRS10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PRS"), model = i)
})
PRS10 <- do.call(cbind, PRS10)

#6
PRE10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PRE"), model = i)
})
PRE10 <- do.call(cbind, PRE10)

#7
RHU10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"RHU"), model = i)
})
RHU10 <- do.call(cbind, RHU10)

#8
GST10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"GST"), model = i)
})
GST10 <- do.call(cbind, GST10)

#10
EBT10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EBT"), model = i)
})
EBT10 <- do.call(cbind, EBT10)

#10
WIN10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"WIN"), model = i)
})
WIN10 <- do.call(cbind, WIN10)

#11
Shrubs10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Shrubs"), model = i)
})
Shrubs10 <- do.call(cbind, Shrubs10)


write.csv(Elevation10,"BRT/OUTPUT/TYPHUS/VAR//Elevation10.csv")
write.csv(GDP10,"BRT/OUTPUT/TYPHUS/VAR//GDP10.csv")
write.csv(MammalRichness10,"BRT/OUTPUT/TYPHUS/VAR//MammalRichness10.csv")
write.csv(SSD10,"BRT/OUTPUT/TYPHUS/VAR//SSD10.csv")
write.csv(PRS10,"BRT/OUTPUT/TYPHUS/VAR//PRS10.csv")
write.csv(PRE10,"BRT/OUTPUT/TYPHUS/VAR//PRE10.csv")
write.csv(RHU10,"BRT/OUTPUT/TYPHUS/VAR//RHU10.csv")
write.csv(GST10,"BRT/OUTPUT/TYPHUS/VAR//GST10.csv")
write.csv(EBT10,"BRT/OUTPUT/TYPHUS/VAR//EBT10.csv")
write.csv(WIN10,"BRT/OUTPUT/TYPHUS/VAR//WIN10.csv")
write.csv(Shrubs10,"BRT/OUTPUT/TYPHUS/VAR//Shrubs10.csv")
