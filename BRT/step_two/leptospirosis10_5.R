...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test5.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk5.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution5.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image5.RData")
...
#7
HV5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV5 <- do.call(cbind, HV5)

#8
Barren5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren5 <- do.call(cbind, Barren5)

write.csv(GDP5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP5.csv")
write.csv(RHU5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU5.csv")
write.csv(PRE5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE5.csv")
write.csv(PRS5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS5.csv")
write.csv(SSD5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD5.csv")
write.csv(HV5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV5.csv")
write.csv(Barren5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren5.csv")
write.csv(MammalRichness5,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness5.csv")
