...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test3.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk3.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution3.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image3.RData")
...
# PD
PD3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD3 <- do.call(rbind, PD3)

# Urban
Urban3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban3 <- do.call(rbind, Urban3)

# ReportEffort
ReportEffort3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort3 <- do.call(rbind, ReportEffort3)
...
write.csv(PD3,"BRT/OUTPUT/RODENTS/VAR/PD3.csv")
write.csv(Urban3,"BRT/OUTPUT/RODENTS/VAR/Urban3.csv")
write.csv(ReportEffort3,"BRT/OUTPUT/RODENTS/VAR/ReportEffort3.csv")
write.csv(MammalRichness3,"BRT/OUTPUT/RODENTS/VAR/MammalRichness3.csv")
write.csv(SSD3,"BRT/OUTPUT/RODENTS/VAR/SSD3.csv")
write.csv(GDP3,"BRT/OUTPUT/RODENTS/VAR/GDP3.csv")
write.csv(EVP3,"BRT/OUTPUT/RODENTS/VAR/EVP3.csv")
write.csv(Elevation3,"BRT/OUTPUT/RODENTS/VAR/Elevation3.csv")
write.csv(RHU3,"BRT/OUTPUT/RODENTS/VAR/RHU3.csv")
write.csv(PRE3,"BRT/OUTPUT/RODENTS/VAR/PRE3.csv")
write.csv(GST3,"BRT/OUTPUT/RODENTS/VAR/GST3.csv")
write.csv(WIN3,"BRT/OUTPUT/RODENTS/VAR/WIN3.csv")