...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test4.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk4.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution4.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image4.RData")
...
# PD
PD4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD4 <- do.call(rbind, PD4)

# Urban
Urban4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban4 <- do.call(rbind, Urban4)

# ReportEffort
ReportEffort4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort4 <- do.call(rbind, ReportEffort4)
...
write.csv(PD4,"BRT/OUTPUT/RODENTS/VAR/PD4.csv")
write.csv(Urban4,"BRT/OUTPUT/RODENTS/VAR/Urban4.csv")
write.csv(ReportEffort4,"BRT/OUTPUT/RODENTS/VAR/ReportEffort4.csv")
write.csv(MammalRichness4,"BRT/OUTPUT/RODENTS/VAR/MammalRichness4.csv")
write.csv(SSD4,"BRT/OUTPUT/RODENTS/VAR/SSD4.csv")
write.csv(GDP4,"BRT/OUTPUT/RODENTS/VAR/GDP4.csv")
write.csv(EVP4,"BRT/OUTPUT/RODENTS/VAR/EVP4.csv")
write.csv(Elevation4,"BRT/OUTPUT/RODENTS/VAR/Elevation4.csv")
write.csv(RHU4,"BRT/OUTPUT/RODENTS/VAR/RHU4.csv")
write.csv(PRE4,"BRT/OUTPUT/RODENTS/VAR/PRE4.csv")
write.csv(GST4,"BRT/OUTPUT/RODENTS/VAR/GST4.csv")
write.csv(WIN4,"BRT/OUTPUT/RODENTS/VAR/WIN4.csv")
