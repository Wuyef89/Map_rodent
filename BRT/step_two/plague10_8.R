...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test8.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk8.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution8.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image8.RData")
...
#5
DNT8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT8 <- do.call(rbind, DNT8)

#6
EVP8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP8 <- do.call(rbind, EVP8)

#7
TEM8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM8 <- do.call(rbind, TEM8)
...
write.csv(MammalRichness8,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness8.csv")
write.csv(GST8,"BRT/OUTPUT/PLAGUE/VAR/GST8.csv")
write.csv(SSD8,"BRT/OUTPUT/PLAGUE/VAR/SSD8.csv")
write.csv(GDP8,"BRT/OUTPUT/PLAGUE/VAR/GDP8.csv")
write.csv(DNT8,"BRT/OUTPUT/PLAGUE/VAR/DNT8.csv")
write.csv(EVP8,"BRT/OUTPUT/PLAGUE/VAR/EVP8.csv")
write.csv(TEM8,"BRT/OUTPUT/PLAGUE/VAR/TEM8.csv")
write.csv(PRE8,"BRT/OUTPUT/PLAGUE/VAR/PRE8.csv")
write.csv(RHU8,"BRT/OUTPUT/PLAGUE/VAR/RHU8.csv")
write.csv(Elevation8,"BRT/OUTPUT/PLAGUE/VAR/Elevation8.csv")
write.csv(PRS8,"BRT/OUTPUT/PLAGUE/VAR/PRS8.csv")
