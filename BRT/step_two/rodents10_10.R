...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test10.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk10.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution10.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image10.RData")
...
# PD
PD10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD10 <- do.call(rbind, PD10)

# Urban
Urban10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban10 <- do.call(rbind, Urban10)

# ReportEffort
ReportEffort10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort10 <- do.call(rbind, ReportEffort10)
...
write.csv(PD10,"BRT/OUTPUT/RODENTS/VAR/PD10.csv")
write.csv(Urban10,"BRT/OUTPUT/RODENTS/VAR/Urban10.csv")
write.csv(ReportEffort10,"BRT/OUTPUT/RODENTS/VAR/ReportEffort10.csv")
write.csv(MammalRichness10,"BRT/OUTPUT/RODENTS/VAR/MammalRichness10.csv")
write.csv(SSD10,"BRT/OUTPUT/RODENTS/VAR/SSD10.csv")
write.csv(GDP10,"BRT/OUTPUT/RODENTS/VAR/GDP10.csv")
write.csv(EVP10,"BRT/OUTPUT/RODENTS/VAR/EVP10.csv")
write.csv(Elevation10,"BRT/OUTPUT/RODENTS/VAR/Elevation10.csv")
write.csv(RHU10,"BRT/OUTPUT/RODENTS/VAR/RHU10.csv")
write.csv(PRE10,"BRT/OUTPUT/RODENTS/VAR/PRE10.csv")
write.csv(GST10,"BRT/OUTPUT/RODENTS/VAR/GST10.csv")
write.csv(WIN10,"BRT/OUTPUT/RODENTS/VAR/WIN10.csv")
