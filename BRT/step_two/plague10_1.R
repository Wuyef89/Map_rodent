...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test1.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk1.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution1.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image1.RData")
...
#5
DNT1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT1 <- do.call(rbind, DNT1)

#6
EVP1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP1 <- do.call(rbind, EVP1)

#7
TEM1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM1 <- do.call(rbind, TEM1)
...
write.csv(MammalRichness1,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness1.csv")
write.csv(GST1,"BRT/OUTPUT/PLAGUE/VAR/GST1.csv")
write.csv(SSD1,"BRT/OUTPUT/PLAGUE/VAR/SSD1.csv")
write.csv(GDP1,"BRT/OUTPUT/PLAGUE/VAR/GDP1.csv")
write.csv(DNT1,"BRT/OUTPUT/PLAGUE/VAR/DNT1.csv")
write.csv(EVP1,"BRT/OUTPUT/PLAGUE/VAR/EVP1.csv")
write.csv(TEM1,"BRT/OUTPUT/PLAGUE/VAR/TEM1.csv")
write.csv(PRE1,"BRT/OUTPUT/PLAGUE/VAR/PRE1.csv")
write.csv(RHU1,"BRT/OUTPUT/PLAGUE/VAR/RHU1.csv")
write.csv(Elevation1,"BRT/OUTPUT/PLAGUE/VAR/Elevation1.csv")
write.csv(PRS1,"BRT/OUTPUT/PLAGUE/VAR/PRS1.csv")
