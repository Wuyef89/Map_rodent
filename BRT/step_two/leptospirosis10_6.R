...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test6.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk6.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution6.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image6.RData")
...
#7
HV6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV6 <- do.call(cbind, HV6)

#8
Barren6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren6 <- do.call(cbind, Barren6)

write.csv(GDP6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP6.csv")
write.csv(RHU6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU6.csv")
write.csv(PRE6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE6.csv")
write.csv(PRS6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS6.csv")
write.csv(SSD6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD6.csv")
write.csv(HV6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV6.csv")
write.csv(Barren6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren6.csv")
write.csv(MammalRichness6,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness6.csv")
