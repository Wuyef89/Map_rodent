...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test10.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk10.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution10.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image10.RData")
...
#7
HV10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV10 <- do.call(cbind, HV10)

#8
Barren10 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren10 <- do.call(cbind, Barren10)

write.csv(GDP10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP10.csv")
write.csv(RHU10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU10.csv")
write.csv(PRE10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE10.csv")
write.csv(PRS10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS10.csv")
write.csv(SSD10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD10.csv")
write.csv(HV10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV10.csv")
write.csv(Barren10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren10.csv")
write.csv(MammalRichness10,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness10.csv")
