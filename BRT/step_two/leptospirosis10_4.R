...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test4.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk4.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution4.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image4.RData")
...
#7
HV4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV4 <- do.call(cbind, HV4)

#8
Barren4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren4 <- do.call(cbind, Barren4)

write.csv(GDP4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP4.csv")
write.csv(RHU4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU4.csv")
write.csv(PRE4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE4.csv")
write.csv(PRS4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS4.csv")
write.csv(SSD4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD4.csv")
write.csv(HV4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV4.csv")
write.csv(Barren4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren4.csv")
write.csv(MammalRichness4,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness4.csv")
