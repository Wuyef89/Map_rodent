...
write.csv(test_table, "BRT/OUTPUT/HFRS/TEST/test5.csv")
...
writeRaster(HFRS.risk, 
            filename = "BRT/OUTPUT/HFRS/TIF/HFRS_risk5.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/HFRS/CONTRIBUTION/contribution5.csv")
save.image("BRT/OUTPUT/HFRS/IMAGE/image5.RData")
...
#3
Barren5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren5 <- do.call(rbind, Barren5)

#4
PRS5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PRS"), model = i)
})
PRS5 <- do.call(rbind, PRS5)
...
write.csv(GDP5,"BRT/OUTPUT/HFRS/VAR/GDP5.csv")
write.csv(Elevation5,"BRT/OUTPUT/HFRS/VAR/Elevation5.csv")
write.csv(Barren5,"BRT/OUTPUT/HFRS/VAR/Barren5.csv")
write.csv(PRS5,"BRT/OUTPUT/HFRS/VAR/PRS5.csv")
write.csv(MammalRichness5,"BRT/OUTPUT/HFRS/VAR/MammalRichness5.csv")
write.csv(SSD5,"BRT/OUTPUT/HFRS/VAR/SSD5.csv")
write.csv(PRE5,"BRT/OUTPUT/HFRS/VAR/PRE5.csv")
write.csv(WIN5,"BRT/OUTPUT/HFRS/VAR/WIN5.csv")
write.csv(RHU5,"BRT/OUTPUT/HFRS/VAR/RHU5.csv")
write.csv(GST5,"BRT/OUTPUT/HFRS/VAR/GST5.csv")
