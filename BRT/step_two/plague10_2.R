...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test2.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk2.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution2.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image2.RData")
...
#5
DNT2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT2 <- do.call(rbind, DNT2)

#6
EVP2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP2 <- do.call(rbind, EVP2)

#7
TEM2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM2 <- do.call(rbind, TEM2)
...
write.csv(MammalRichness2,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness2.csv")
write.csv(GST2,"BRT/OUTPUT/PLAGUE/VAR/GST2.csv")
write.csv(SSD2,"BRT/OUTPUT/PLAGUE/VAR/SSD2.csv")
write.csv(GDP2,"BRT/OUTPUT/PLAGUE/VAR/GDP2.csv")
write.csv(DNT2,"BRT/OUTPUT/PLAGUE/VAR/DNT2.csv")
write.csv(EVP2,"BRT/OUTPUT/PLAGUE/VAR/EVP2.csv")
write.csv(TEM2,"BRT/OUTPUT/PLAGUE/VAR/TEM2.csv")
write.csv(PRE2,"BRT/OUTPUT/PLAGUE/VAR/PRE2.csv")
write.csv(RHU2,"BRT/OUTPUT/PLAGUE/VAR/RHU2.csv")
write.csv(Elevation2,"BRT/OUTPUT/PLAGUE/VAR/Elevation2.csv")
write.csv(PRS2,"BRT/OUTPUT/PLAGUE/VAR/PRS2.csv")
