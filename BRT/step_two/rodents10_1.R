...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test1.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk1.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution1.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image1.RData")
...
# PD
PD1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD1 <- do.call(rbind, PD1)

# Urban
Urban1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban1 <- do.call(rbind, Urban1)

# ReportEffort
ReportEffort1 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort1 <- do.call(rbind, ReportEffort1)
...
write.csv(PD1,"BRT/OUTPUT/RODENTS/VAR/PD1.csv")
write.csv(Urban1,"BRT/OUTPUT/RODENTS/VAR/Urban1.csv")
write.csv(ReportEffort1,"BRT/OUTPUT/RODENTS/VAR/ReportEffort1.csv")
write.csv(MammalRichness1,"BRT/OUTPUT/RODENTS/VAR/MammalRichness1.csv")
write.csv(SSD1,"BRT/OUTPUT/RODENTS/VAR/SSD1.csv")
write.csv(GDP1,"BRT/OUTPUT/RODENTS/VAR/GDP1.csv")
write.csv(EVP1,"BRT/OUTPUT/RODENTS/VAR/EVP1.csv")
write.csv(Elevation1,"BRT/OUTPUT/RODENTS/VAR/Elevation1.csv")
write.csv(RHU1,"BRT/OUTPUT/RODENTS/VAR/RHU1.csv")
write.csv(PRE1,"BRT/OUTPUT/RODENTS/VAR/PRE1.csv")
write.csv(GST1,"BRT/OUTPUT/RODENTS/VAR/GST1.csv")
write.csv(WIN1,"BRT/OUTPUT/RODENTS/VAR/WIN1.csv")
