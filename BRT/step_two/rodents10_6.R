...
# PD
PD6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD6 <- do.call(rbind, PD6)

# Urban
Urban6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban6 <- do.call(rbind, Urban6)

# ReportEffort
ReportEffort6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort6 <- do.call(rbind, ReportEffort6)
...
write.csv(PD6,"BRT/OUTPUT/RODENTS/VAR/PD6.csv")
write.csv(Urban6,"BRT/OUTPUT/RODENTS/VAR/Urban6.csv")
write.csv(ReportEffort6,"BRT/OUTPUT/RODENTS/VAR/ReportEffort6.csv")
write.csv(MammalRichness6,"BRT/OUTPUT/RODENTS/VAR/MammalRichness6.csv")
write.csv(SSD6,"BRT/OUTPUT/RODENTS/VAR/SSD6.csv")
write.csv(GDP6,"BRT/OUTPUT/RODENTS/VAR/GDP6.csv")
write.csv(EVP6,"BRT/OUTPUT/RODENTS/VAR/EVP6.csv")
write.csv(Elevation6,"BRT/OUTPUT/RODENTS/VAR/Elevation6.csv")
write.csv(RHU6,"BRT/OUTPUT/RODENTS/VAR/RHU6.csv")
write.csv(PRE6,"BRT/OUTPUT/RODENTS/VAR/PRE6.csv")
write.csv(GST6,"BRT/OUTPUT/RODENTS/VAR/GST6.csv")
write.csv(WIN6,"BRT/OUTPUT/RODENTS/VAR/WIN6.csv")
