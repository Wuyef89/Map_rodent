...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test2.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk2.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution2.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image2.RData")
...
# PD
PD2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD2 <- do.call(rbind, PD2)

# Urban
Urban2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban2 <- do.call(rbind, Urban2)

# ReportEffort
ReportEffort2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort2 <- do.call(rbind, ReportEffort2)
...
write.csv(PD2,"BRT/OUTPUT/RODENTS/VAR/PD2.csv")
write.csv(Urban2,"BRT/OUTPUT/RODENTS/VAR/Urban2.csv")
write.csv(ReportEffort2,"BRT/OUTPUT/RODENTS/VAR/ReportEffort2.csv")
write.csv(MammalRichness2,"BRT/OUTPUT/RODENTS/VAR/MammalRichness2.csv")
write.csv(SSD2,"BRT/OUTPUT/RODENTS/VAR/SSD2.csv")
write.csv(GDP2,"BRT/OUTPUT/RODENTS/VAR/GDP2.csv")
write.csv(EVP2,"BRT/OUTPUT/RODENTS/VAR/EVP2.csv")
write.csv(Elevation2,"BRT/OUTPUT/RODENTS/VAR/Elevation2.csv")
write.csv(RHU2,"BRT/OUTPUT/RODENTS/VAR/RHU2.csv")
write.csv(PRE2,"BRT/OUTPUT/RODENTS/VAR/PRE2.csv")
write.csv(GST2,"BRT/OUTPUT/RODENTS/VAR/GST2.csv")
write.csv(WIN2,"BRT/OUTPUT/RODENTS/VAR/WIN2.csv")
