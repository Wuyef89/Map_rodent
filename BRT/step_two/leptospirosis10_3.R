...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test3.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk3.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution3.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image3.RData")
...
#7
HV3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV3 <- do.call(cbind, HV3)

#8
Barren3 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren3 <- do.call(cbind, Barren3)

write.csv(GDP3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP3.csv")
write.csv(RHU3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU3.csv")
write.csv(PRE3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE3.csv")
write.csv(PRS3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS3.csv")
write.csv(SSD3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD3.csv")
write.csv(HV3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV3.csv")
write.csv(Barren3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren3.csv")
write.csv(MammalRichness3,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness3.csv")
