...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test5.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk5.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution5.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image5.RData")
...
#5
DNT5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT5 <- do.call(rbind, DNT5)
...
#7
TEM5 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM5 <- do.call(rbind, TEM5)
...
write.csv(MammalRichness5,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness5.csv")
write.csv(GST5,"BRT/OUTPUT/PLAGUE/VAR/GST5.csv")
write.csv(SSD5,"BRT/OUTPUT/PLAGUE/VAR/SSD5.csv")
write.csv(GDP5,"BRT/OUTPUT/PLAGUE/VAR/GDP5.csv")
write.csv(DNT5,"BRT/OUTPUT/PLAGUE/VAR/DNT5.csv")
write.csv(EVP5,"BRT/OUTPUT/PLAGUE/VAR/EVP5.csv")
write.csv(TEM5,"BRT/OUTPUT/PLAGUE/VAR/TEM5.csv")
write.csv(PRE5,"BRT/OUTPUT/PLAGUE/VAR/PRE5.csv")
write.csv(RHU5,"BRT/OUTPUT/PLAGUE/VAR/RHU5.csv")
write.csv(Elevation5,"BRT/OUTPUT/PLAGUE/VAR/Elevation5.csv")
write.csv(PRS5,"BRT/OUTPUT/PLAGUE/VAR/PRS5.csv")
