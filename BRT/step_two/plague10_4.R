...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test4.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk4.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution4.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image4.RData")
...
#5
DNT4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT4 <- do.call(rbind, DNT4)

#6
EVP4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP4 <- do.call(rbind, EVP4)

#7
TEM4 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM4 <- do.call(rbind, TEM4)
...
write.csv(MammalRichness4,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness4.csv")
write.csv(GST4,"BRT/OUTPUT/PLAGUE/VAR/GST4.csv")
write.csv(SSD4,"BRT/OUTPUT/PLAGUE/VAR/SSD4.csv")
write.csv(GDP4,"BRT/OUTPUT/PLAGUE/VAR/GDP4.csv")
write.csv(DNT4,"BRT/OUTPUT/PLAGUE/VAR/DNT4.csv")
write.csv(EVP4,"BRT/OUTPUT/PLAGUE/VAR/EVP4.csv")
write.csv(TEM4,"BRT/OUTPUT/PLAGUE/VAR/TEM4.csv")
write.csv(PRE4,"BRT/OUTPUT/PLAGUE/VAR/PRE4.csv")
write.csv(RHU4,"BRT/OUTPUT/PLAGUE/VAR/RHU4.csv")
write.csv(Elevation4,"BRT/OUTPUT/PLAGUE/VAR/Elevation4.csv")
write.csv(PRS4,"BRT/OUTPUT/PLAGUE/VAR/PRS4.csv")
