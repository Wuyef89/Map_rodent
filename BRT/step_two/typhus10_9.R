...
write.csv(test_table,"BRT/OUTPUT/TYPHUS/TEST/test9.csv")
...
writeRaster(typhus.risk, 
            filename = "BRT/OUTPUT/TYPHUS/TIF/typhus_risk9.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/TYPHUS/CONTRIBUTION/contribution9.csv")
save.image("BRT/OUTPUT/TYPHUS/IMAGE/image9.RData")
...
Elevation9 <- do.call(cbind, Elevation9)
...
GST9 <- do.call(cbind, GST9)

#9
EBT9 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EBT"), model = i)
})
EBT9 <- do.call(cbind, EBT9)

#10
WIN9 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"WIN"), model = i)
})
WIN9 <- do.call(cbind, WIN9)

#11
Shrubs9 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Shrubs"), model = i)
})
Shrubs9 <- do.call(cbind, Shrubs9)


write.csv(Elevation9,"BRT/OUTPUT/TYPHUS/VAR//Elevation9.csv")
write.csv(GDP9,"BRT/OUTPUT/TYPHUS/VAR//GDP9.csv")
write.csv(MammalRichness9,"BRT/OUTPUT/TYPHUS/VAR//MammalRichness9.csv")
write.csv(SSD9,"BRT/OUTPUT/TYPHUS/VAR//SSD9.csv")
write.csv(PRS9,"BRT/OUTPUT/TYPHUS/VAR//PRS9.csv")
write.csv(PRE9,"BRT/OUTPUT/TYPHUS/VAR//PRE9.csv")
write.csv(RHU9,"BRT/OUTPUT/TYPHUS/VAR//RHU9.csv")
write.csv(GST9,"BRT/OUTPUT/TYPHUS/VAR//GST9.csv")
write.csv(EBT9,"BRT/OUTPUT/TYPHUS/VAR//EBT9.csv")
write.csv(WIN9,"BRT/OUTPUT/TYPHUS/VAR//WIN9.csv")
write.csv(Shrubs9,"BRT/OUTPUT/TYPHUS/VAR//Shrubs9.csv")
