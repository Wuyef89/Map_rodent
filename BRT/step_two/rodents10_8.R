...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test8.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk8.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution8.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image8.RData")
...
# PD
PD8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD8 <- do.call(rbind, PD8)

# Urban
Urban8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban8 <- do.call(rbind, Urban8)

# ReportEffort
ReportEffort8 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort8 <- do.call(rbind, ReportEffort8)
...
write.csv(PD8,"BRT/OUTPUT/RODENTS/VAR/PD8.csv")
write.csv(Urban8,"BRT/OUTPUT/RODENTS/VAR/Urban8.csv")
write.csv(ReportEffort8,"BRT/OUTPUT/RODENTS/VAR/ReportEffort8.csv")
write.csv(MammalRichness8,"BRT/OUTPUT/RODENTS/VAR/MammalRichness8.csv")
write.csv(SSD8,"BRT/OUTPUT/RODENTS/VAR/SSD8.csv")
write.csv(GDP8,"BRT/OUTPUT/RODENTS/VAR/GDP8.csv")
write.csv(EVP8,"BRT/OUTPUT/RODENTS/VAR/EVP8.csv")
write.csv(Elevation8,"BRT/OUTPUT/RODENTS/VAR/Elevation8.csv")
write.csv(RHU8,"BRT/OUTPUT/RODENTS/VAR/RHU8.csv")
write.csv(PRE8,"BRT/OUTPUT/RODENTS/VAR/PRE8.csv")
write.csv(GST8,"BRT/OUTPUT/RODENTS/VAR/GST8.csv")
write.csv(WIN8,"BRT/OUTPUT/RODENTS/VAR/WIN8.csv")
