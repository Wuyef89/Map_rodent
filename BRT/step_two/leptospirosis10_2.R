...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test2.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk2.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution2.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image2.RData")
...
#7
HV2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV2 <- do.call(cbind, HV2)

#8
Barren2 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren2 <- do.call(cbind, Barren2)

write.csv(GDP2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP2.csv")
write.csv(RHU2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU2.csv")
write.csv(PRE2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE2.csv")
write.csv(PRS2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS2.csv")
write.csv(SSD2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD2.csv")
write.csv(HV2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV2.csv")
write.csv(Barren2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren2.csv")
write.csv(MammalRichness2,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness2.csv")
