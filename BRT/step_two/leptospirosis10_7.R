...
write.csv(test_table,"BRT/OUTPUT/LEPTOSPIROSIS/TEST/test7.csv")
...
writeRaster(leptospirosis.risk, 
            filename = "BRT/OUTPUT/LEPTOSPIROSIS/TIF/leptospirosis_risk7.tif", overwrite=TRUE)
...
write.csv(contribution.all,"BRT/OUTPUT/LEPTOSPIROSIS/CONTRIBUTION/contribution7.csv")
save.image("BRT/OUTPUT/LEPTOSPIROSIS/IMAGE/image7.RData")
...
#7
HV7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"HV"), model = i)
})
HV7 <- do.call(cbind, HV7)

#8
Barren7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Barren"), model = i)
})
Barren7 <- do.call(cbind, Barren7)

write.csv(GDP7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/GDP7.csv")
write.csv(RHU7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/RHU7.csv")
write.csv(PRE7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRE7.csv")
write.csv(PRS7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/PRS7.csv")
write.csv(SSD7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/SSD7.csv")
write.csv(HV7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/HV7.csv")
write.csv(Barren7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/Barren7.csv")
write.csv(MammalRichness7,"BRT/OUTPUT/LEPTOSPIROSIS/VAR/MammalRichness7.csv")
