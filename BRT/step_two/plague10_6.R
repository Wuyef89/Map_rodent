...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test6.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk6.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution6.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image6.RData")
...
#5
DNT6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT6 <- do.call(rbind, DNT6)

#6
EVP6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP6 <- do.call(rbind, EVP6)

#7
TEM6 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM6 <- do.call(rbind, TEM6)
...
write.csv(MammalRichness6,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness6.csv")
write.csv(GST6,"BRT/OUTPUT/PLAGUE/VAR/GST6.csv")
write.csv(SSD6,"BRT/OUTPUT/PLAGUE/VAR/SSD6.csv")
write.csv(GDP6,"BRT/OUTPUT/PLAGUE/VAR/GDP6.csv")
write.csv(DNT6,"BRT/OUTPUT/PLAGUE/VAR/DNT6.csv")
write.csv(EVP6,"BRT/OUTPUT/PLAGUE/VAR/EVP6.csv")
write.csv(TEM6,"BRT/OUTPUT/PLAGUE/VAR/TEM6.csv")
write.csv(PRE6,"BRT/OUTPUT/PLAGUE/VAR/PRE6.csv")
write.csv(RHU6,"BRT/OUTPUT/PLAGUE/VAR/RHU6.csv")
write.csv(Elevation6,"BRT/OUTPUT/PLAGUE/VAR/Elevation6.csv")
write.csv(PRS6,"BRT/OUTPUT/PLAGUE/VAR/PRS6.csv")
