...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test7.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk7.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution7.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image7.RData")
...
#5
DNT7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT7 <- do.call(rbind, DNT7)

#6
EVP7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"EVP"), model = i)
})
EVP7 <- do.call(rbind, EVP7)

#7
TEM7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM7 <- do.call(rbind, TEM7)
...
write.csv(MammalRichness7,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness7.csv")
write.csv(GST7,"BRT/OUTPUT/PLAGUE/VAR/GST7.csv")
write.csv(SSD7,"BRT/OUTPUT/PLAGUE/VAR/SSD7.csv")
write.csv(GDP7,"BRT/OUTPUT/PLAGUE/VAR/GDP7.csv")
write.csv(DNT7,"BRT/OUTPUT/PLAGUE/VAR/DNT7.csv")
write.csv(EVP7,"BRT/OUTPUT/PLAGUE/VAR/EVP7.csv")
write.csv(TEM7,"BRT/OUTPUT/PLAGUE/VAR/TEM7.csv")
write.csv(PRE7,"BRT/OUTPUT/PLAGUE/VAR/PRE7.csv")
write.csv(RHU7,"BRT/OUTPUT/PLAGUE/VAR/RHU7.csv")
write.csv(Elevation7,"BRT/OUTPUT/PLAGUE/VAR/Elevation7.csv")
write.csv(PRS7,"BRT/OUTPUT/PLAGUE/VAR/PRS7.csv")
