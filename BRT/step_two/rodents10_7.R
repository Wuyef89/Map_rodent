...
auc(precrec_obj)
write.csv(test_table, "BRT/OUTPUT/RODENTS/TEST/test7.csv")
...
writeRaster(rodents.risk, 
            filename = "BRT/OUTPUT/RODENTS/TIF/rodents_risk7.tif", overwrite = TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/RODENTS/CONTRIBUTION/contribution7.csv")
save.image("BRT/OUTPUT/RODENTS/IMAGE/image7.RData")
...
# PD
PD7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"PD"), model = i)
})
PD7 <- do.call(rbind, PD7)

# Urban
Urban7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"Urban"), model = i)
})
Urban7 <- do.call(rbind, Urban7)

# ReportEffort
ReportEffort7 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"ReportEffort"), model = i)
})
ReportEffort7 <- do.call(rbind, ReportEffort7)
...
write.csv(PD7,"BRT/OUTPUT/RODENTS/VAR/PD7.csv")
write.csv(Urban7,"BRT/OUTPUT/RODENTS/VAR/Urban7.csv")
write.csv(ReportEffort7,"BRT/OUTPUT/RODENTS/VAR/ReportEffort7.csv")
write.csv(MammalRichness7,"BRT/OUTPUT/RODENTS/VAR/MammalRichness7.csv")
write.csv(SSD7,"BRT/OUTPUT/RODENTS/VAR/SSD7.csv")
write.csv(GDP7,"BRT/OUTPUT/RODENTS/VAR/GDP7.csv")
write.csv(EVP7,"BRT/OUTPUT/RODENTS/VAR/EVP7.csv")
write.csv(Elevation7,"BRT/OUTPUT/RODENTS/VAR/Elevation7.csv")
write.csv(RHU7,"BRT/OUTPUT/RODENTS/VAR/RHU7.csv")
write.csv(PRE7,"BRT/OUTPUT/RODENTS/VAR/PRE7.csv")
write.csv(GST7,"BRT/OUTPUT/RODENTS/VAR/GST7.csv")
write.csv(WIN7,"BRT/OUTPUT/RODENTS/VAR/WIN7.csv")
