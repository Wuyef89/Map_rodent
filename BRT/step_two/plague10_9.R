...
write.csv(test_table,"BRT/OUTPUT/PLAGUE/TEST/test9.csv")
...
writeRaster(plague.risk, 
            filename = "BRT/OUTPUT/PLAGUE/TIF/plague_risk9.tif", overwrite=TRUE)
...
write.csv(contribution.all, "BRT/OUTPUT/PLAGUE/CONTRIBUTION/contribution9.csv")
save.image("BRT/OUTPUT/PLAGUE/IMAGE/image9.RData")
...
#5
DNT9 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"DNT"), model = i)
})
DNT9 <- do.call(rbind, DNT9)
...
#7
TEM9 <- lapply(1:length(model_list),function(i){
  data.frame(getVar(model_list[[i]],"TEM"), model = i)
})
TEM9 <- do.call(rbind, TEM9)
...
write.csv(MammalRichness9,"BRT/OUTPUT/PLAGUE/VAR/MammalRichness9.csv")
write.csv(GST9,"BRT/OUTPUT/PLAGUE/VAR/GST9.csv")
write.csv(SSD9,"BRT/OUTPUT/PLAGUE/VAR/SSD9.csv")
write.csv(GDP9,"BRT/OUTPUT/PLAGUE/VAR/GDP9.csv")
write.csv(DNT9,"BRT/OUTPUT/PLAGUE/VAR/DNT9.csv")
write.csv(EVP9,"BRT/OUTPUT/PLAGUE/VAR/EVP9.csv")
write.csv(TEM9,"BRT/OUTPUT/PLAGUE/VAR/TEM9.csv")
write.csv(PRE9,"BRT/OUTPUT/PLAGUE/VAR/PRE9.csv")
write.csv(RHU9,"BRT/OUTPUT/PLAGUE/VAR/RHU9.csv")
write.csv(Elevation9,"BRT/OUTPUT/PLAGUE/VAR/Elevation9.csv")
write.csv(PRS9,"BRT/OUTPUT/PLAGUE/VAR/PRS9.csv")
